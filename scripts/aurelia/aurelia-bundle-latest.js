...
/***/ function(module, exports, __webpack_require__) {
	...
	$def($def.P, 'Array', {
	  ...
	  findIndex: __webpack_require__(62)(6)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $def = __webpack_require__(58);
	$def($def.S, 'RegExp', {
	  escape: __webpack_require__(67)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function setStatics(keys, length){
	  $.each.call(keys.split(','), function(key){
	    ...
	    else if(key in [])statics[key] = __webpack_require__(73)(Function.call, [][key], length);
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if($.DESC && $.FW)$.setDesc(C, __webpack_require__(68)('species'), {
	    configurable: true,
	    get: $.that
	  });
	};
  ...
  function loadComponent(routeLoader, navigationContext, config) {
    ...
    return routeLoader.loadRoute(router, config).then(function (component) {
      ...
      if ('configureRouter' in component.executionContext) {
        ...
        var config = new _routerConfiguration.RouterConfiguration();
        var result = (_component$executionContext = component.executionContext).configureRouter.apply(_component$executionContext, [config, component.childRouter].concat(_toConsumableArray(lifecycleArgs))) || Promise.resolve();
